									...
									<div className="u-container-layout u-valign-middle u-container-layout-1">
										<h3 className="u-custom-font u-font-ubuntu u-text u-text-1">
											...
											<span style={{ fontSize: "1.5rem" }}>
												We do not trouble you with credit/debit card entries.
												Instead, we take cash on delivery. Recently e have
												updated our policy even more. Now you can check the
												parcel before accepting the parcel & paying for it. We
												did this to build an even more trusted relationship with
												all of you. Order from pakeeza electronics, check your
												parcel when received & return it if its not what you
												seek.
											</span>
											<br />
										</h3>
