...
const HomeApp = (props) => {
	...
	const handleSubmit = async (e) => {
		...
		axios
			.get(
				`https://pakeeza-backend-railway-production.up.railway.app/api/products?filters[Category][$eq]=Appliance&filters[SubCategories][$eq]=${value}&populate=*`
			)
			.then((response) => {
				// Handle success.
														...
														<div className="space-y-4">
															...
															<div className="flex items-center">
																<input
																	...
																	type="checkbox"
																	defaultValue="DOMESTICAPPLIANCES"
																	onChange={handleChange}
																	className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
																/>
																<label className="ml-3 min-w-0 flex-1 text-gray-500">
