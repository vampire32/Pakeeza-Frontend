...
const Kitchen = (props) => {
	...
	const handleSubmit = async (e) => {
		...
		axios
			.get(
				`https://pakeeza-backend-railway-production.up.railway.app/api/products?filters[Category][$eq]=Kitchen&filters[SubCategories][$eq]=${value}&populate=*`
			)
			.then((response) => {
				// Handle success.
